...
const SEED_TASKS: SeedTask[] = [
  ...
  // ===== Tomorrow 11 Mar 2026 =====
  {
    title: 'Send Tom Wie feedback: add LD to last sales contract',
    description: 'Send feedback to Tom Wie to add Liquidated Damages (LD) to last sales contract',
    project: 'legal',
    priority: 'high',
    deadline: '2026-03-11',
  },
  {
    title: 'Get proper EPC contract to all clients',
    description: 'Distribute/finalize EPC contract to all BESS clients',
    project: 'clients',
    priority: 'high',
    deadline: '2026-03-11',
  },
  {
    title: 'Final client full offers to group clients + Spanercom',
    description: 'Send final full offers to group clients and Spanercom',
    project: 'clients',
    priority: 'high',
    deadline: '2026-03-11',
  },
  {
    title: 'Send out bankability docs and Marsh update',
    description: 'Send bankability documentation and Marsh insurance update to relevant parties',
    project: 'bess_cyprus',
    priority: 'high',
    deadline: '2026-03-11',
  },
  {
    title: 'Prepare and send AIG insurance RFP',
    description: 'Prepare another insurance RFP for AIG based on forms they sent; send when ready',
    project: 'bess_cyprus',
    priority: 'high',
    deadline: '2026-03-11',
    notes: 'Use AIG forms as basis for RFP preparation',
  },
  {
    title: 'Send commission schedule referral contract to Martins',
    description: 'Send referral contract (commission schedule) to Martins, similar to what was sent to Yiannos Georgiades',
    project: 'legal',
    priority: 'high',
    deadline: '2026-03-11',
  },
  {
    title: 'Finalize warehouse lease',
    description: 'Finalize warehouse lease (BESS/7SUN as applicable)',
    project: 'bess_cyprus',
    priority: 'high',
    deadline: '2026-03-11',
  },
