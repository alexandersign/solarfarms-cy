# LighthiefEMS - Technical Reference Document

## Project: LighthiefEMS & SCADA Development

> **Purpose**: This document consolidates all DSO data, product datasheets, and technical specifications for the development of the LighthiefEMS solution - a proprietary Energy Management System and SCADA platform with integrated Battery Storage Management (BSM) in Phase 2.
...
### 1.1 LighthiefEMS Vision

| Phase | Scope | Timeline |
|-------|-------|----------|
| **Phase 1** | EMS/SCADA Core Development | 2026 |
| **Phase 2** | Integrated BSM (Battery Storage Management) | 2026-2027 |
...
| Parameter | Requirement | LighthiefEMS Target |
|-----------|-------------|---------------------|
...
| Parameter | Requirement | LighthiefEMS |
|-----------|-------------|--------------|
