/**
 * Ragelia Portfolio — Park #2105 (0.69 MWp PV)
 * Slug: ragelia-2105 | Ref: PARK-RTB-RAG2105-2026
 * Source: Projects_Offer.pdf (Ragelia Investments Ltd, Apr 2026)
 *
 * Asking price: €276,000 (100% SPV share purchase)
...
const landLease = 7_000     // indicative annual lease (registered)

const rev   = computeRevenueModel({ solarMWp, specificYieldKwhPerKwp: specificYield, curtailmentPct, bessCapacityMWh: bessMWh })
const capex = computeCapex({ solarMWp, bessCapacityMWh: bessMWh, rtbCost: 276_000 })  // seller's asking price
...
export const RAGELIA_2105_RTB: RtbDeal = {
  slug: 'ragelia-2105',
  referenceCode: 'PARK-RTB-RAG2105-2026',

  publicTitle: 'Solar Park #2105 with Battery Storage — 0.69 MWp',
  ...
  _meta: {
    date: '2026-05-10',
    confidential: true,
    note: 'RTB acquisition price per seller offer (Apr 2026). BESS added by Lighthief (not in original CERA licence — licence amendment required). Grid offer expected Q3 2026.',
  },
}
