...
const MANUAL_LISTINGS: InvestmentListing[] = [
  ...
  },
  {
    ...
    teaserFile: '/lighthief-cyprus/parks-for-sale/galascope-5mw-trackers/galascope-5mw-investor-teaser-jun2026.html',
    modelFile: '/lighthief-cyprus/parks-for-sale/galascope-5mw-trackers/galascope-5mw-investor-model-jun2026.xlsx',
    loiPreset: {
      projectName: '5.01 MWp operational solar (PARK-REF-5001)',
      projectReference: 'PARK-REF-5001',
      projectCapacityMW: 5.01,
      estimatedInvestment: 9_000_000,
      bessIncluded: false,
