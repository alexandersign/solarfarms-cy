# Alexander — Founder alignment & pre–client-sign documents

**Purpose:** Process advice and **draft** agreement frameworks for the Managing Director to align with the **founder** *before* the company executes the major client contract.
...
| `FOUNDER-SEND-GUIDANCE.md` | **Pre-send strategy** — Shapiro pushback map, what to send founder, cover email |
| `EXECUTION-CHECKLIST.md` | **Pre-sign checklist** — payroll, Annex B, deed execution, v5 pack |
| `DRAFT-DIRECTOR-AND-OFFICER-PROTECTIONS.md` | **D&O insurance + Cap. 113 indemnity** — director + secretary |
| `DRAFT-SHAREHOLDER-RESOLUTION-DO-INSURANCE.md` | **Sybaris resolution** — approve D&O premium + indemnity deed |
