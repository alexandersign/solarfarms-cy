...
export default function HomePage() {
  return (
    <>
      ...
      {/* Featured Project - PARK-REF-5001 */}
      <section className="section-padding bg-gradient-to-br from-solar-50 via-white to-cyprus-50">
        <div className="container">
          <div className="text-center mb-12">
            <span className="inline-block bg-solar-100 text-solar-800 text-sm font-semibold px-4 py-2 rounded-full mb-4">
              🔥 Featured Opportunity
            </span>
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">
              5.01MW Premium Solar Park
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Ready-to-build single-axis tracking system with BESS upgrade option
            </p>
          </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="5.01MW Solar Park in Cyprus"
                  width={600}
                  height={400}
                  className="w-full h-auto"
                />
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-sm border">
                  ...
                  <div className="text-2xl font-bold gradient-text">€9.6M</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-sm border">
                  <div className="text-sm text-gray-600">Capacity</div>
                  <div className="text-2xl font-bold text-gray-900">5.01 MW DC</div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-sm border">
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border">
                  ...
                  <div className="text-2xl font-bold text-green-600">RTB</div>
                </div>
              </div>
              
              <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-xl p-4">
                <div className="flex items-center gap-2 text-red-800 font-semibold mb-2">
                  ⚠️ Curtailment Alert: BESS Recommended
                </div>
                <p className="text-red-700 text-sm">
                  Cyprus curtailment at 45.8%. This park includes BESS upgrade analysis showing 
                  how battery storage can recover lost revenue and boost ROI from 13.3% to 13.6%.
                </p>
              </div>
