...
export default function CyprusEnergyStorageRoadmapArticle() {
  return (
    <div className="min-h-screen">
      ...
      <BlogFeaturedImage
        src="/images/blog/cyprus-energy-storage-roadmap-2027-2030.jpg"
        alt="Cyprus solar farm and battery containers at dusk"
      />
                  ...
                  <CardContent>
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start space-x-2">
                        ...
                        <span>Lighthief&apos;s large-scale BESS portfolio will be among the first</span>
                      </li>
                      <li className="flex items-start space-x-2">
                        <CheckCircle className="w-4 h-4 text-emerald-500 flex-shrink-0 mt-0.5" />
                ...
                <Card className="border-blue-200">
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-700">
                      ...
                      Lighthief&apos;s large-scale BESS portfolio is planned to enter operation,
