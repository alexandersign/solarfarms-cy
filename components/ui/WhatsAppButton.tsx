...
export function WhatsAppButton({ 
  ...
  useEffect(() => {
    ...
    // Hide tooltip after 5 more seconds
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {showTooltip && (
        <div className="relative animate-fade-in-up">
          <div className="bg-white rounded-2xl shadow-2xl p-4 max-w-[280px] border border-gray-100">
            <button
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900 text-sm">
                  Need help with solar investment?
                </p>
                <p className="text-gray-600 text-xs mt-1">
                  Chat with Alexander on WhatsApp for immediate assistance.
                </p>
              </div>
            </div>
          </div>
